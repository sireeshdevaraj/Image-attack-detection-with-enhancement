...
if val == 'y':
	...
	plt.title("histogram of Fingerprint before equaization")
	...
	print("if we use histogram equivalization for this fingerprint without moving the data in output directory, we may loose the processed and unprocessed Fingerprints of previous fingerprints")
	time.sleep(0.7)
